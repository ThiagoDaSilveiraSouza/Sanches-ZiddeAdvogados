    ...
    <WhoWheAreContent className="centralizer">
        ...
        <CardPerformance>
          <p>
            ...
            societário e direito contratual. Nossos atendimentos são
            humanizados, o que nos faz respeitar e dar a devida importância aos
            problemas que nos são trazidos, de modo a encontrarmos a solução que
            melhor se encaixe para cada caso individualizado, otimizando tempo e
